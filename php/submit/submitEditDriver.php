...
$driverId = $_REQUEST['driverId']; if($driverId == 0 || $driverId == '') die(wrapError(ERROR_CODE_FIVE,'INTERNAL ERROR'));
...
$driverId = saveEditDriver($conexion, $driverId, $broker, $first, $last, $ssn, $tel, $mobile, $carrier, $email, $start, $percentage, $term,
