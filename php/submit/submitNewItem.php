...
$existing = objectQuery($conexion, '*', 'item', "projectId = '$project' AND supplierId = '$supplier' AND materialId = '$material' AND itemType = '$type' AND itemMaterialPrice = '$materialPrice' AND itemBrokerCost = '$brokerCost' AND itemCustomerCost = '$customerCost'");
if($existing != null) die (wrapFormError(ERROR_CODE_DUPLICATE, "The item already exists"));

$number = "0";
$last = objectQuery($conexion,'*','item',"projectId = '$project' ORDER BY itemNumber desc limit 1");
if($last != null) {
...
$itemId = saveNewItem($conexion, $number, $project, $supplier, $material, 0, 0, $fromText, $toText, $materialPrice, $brokerCost, $customerCost, $type, $description);
