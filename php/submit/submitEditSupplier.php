...
$supplierId = $_REQUEST['supplierId']; if($supplierId == 0 || $supplierId == '') die(wrapError(ERROR_CODE_FIVE,'INTERNAL ERROR'));
...
$existingSupplier = objectQuery($conexion, '*', 'supplier', "supplierName = '$name' AND vendorId = '$vendor' AND supplierId <> '$supplierId'");
...
$supplierId = saveEditSupplier($conexion, $supplierId, $vendor, $name, $tel, $fax, $info, $dumptime, $line1, $line2, $city, $state, $zip, $box);
