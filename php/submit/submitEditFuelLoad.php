...
$fuelLoadId = $_REQUEST['fuelLoadId']; if($fuelLoadId == 0 || $fuelLoadId == '') die(wrapError(ERROR_CODE_FIVE,'INTERNAL ERROR'));
...
$fuel = saveEditFuelLoad($conexion, $fuelLoadId, $broker, $truck, $date, $comment, $start, $finish, $registered, $miles);
