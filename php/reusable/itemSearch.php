...
$(document).ready(function() {
	...
	$(document).on('dblclick', '.doubleClickable', function() {
		var url = '/mfi/php/nyros/viewItem.php?itemId=' + $(this).attr('itemId');
...
function printItems() {
	var data = getParams();
	var url = "../reports/genericReport.php?" + data + "&title=Item&sub=Search&type=item";
	var windowName = 'Item Report';
...
function searchItems() {
	var data = getParams();
	var url = "../retrieve/getItemsTable.php";
...
function getParams() {
	...
	dataArray['itemId'] = getVal('searchItemId');
	dataArray['type'] = getVal('searchItemType');
		...
		<table class="listing form" cellpadding="0" cellspacing="0" >
			...
			<tr>
				...
				<td class='first' rowspan='6'>
					...
					<?php echo createCheckbox('c_itemId','Item','itemId', 'checked="checked" headerName="Item" varType="string"'); ?><br/>
					...
					<?php echo createCheckbox('c_itemNumber','Number','itemNumber', 'headerName="Number" varType="string"'); ?><br/>
					...
					<?php echo createCheckbox('c_itemType','Item Type','itemTypeString', 'headerName="Type" varType="string"'); ?><br/>
			...
			<tr class='bg'>
				...
				<td><?php echo arrayToSelect(array("Loads","Tons","Hours","Any"),3,"searchItemType","",true);?></td>
