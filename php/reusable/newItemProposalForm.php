...
$(document).ready(function() {
	...
	$('#submitNewItemProposal').click(function() {
		submitNewItemProposal();
	});
	
});

function submitNewItemProposal() {
	var data = getNewItemProposalParams();
	var url = '../submit/submitNewItemProposal.php';
...
<div id="center-column">
	<div class="table">
		...
		<table>
			<tr>
				<td><?php echo createSimpleButton('submitNewItemProposal', 'Submit');?></td>
			</tr>
		</table>
	</div>
</div>
