...
if(isset($_GET['materialId']))
{
	...
	if($num>0){
		...
		while($row = mysql_fetch_assoc($result)){
			...
			if($_GET['pathType'] == '1') {
				$tbody.="<td id='supplier".$row['supplierId']."' class='toNew' ><img class='newProposalIcon' supplierId='".$row['supplierId']."' src='".IMG_NEW_PROPOSAL."' width='22px' /></td><td></td>";
			} else {
				$tbody.="
					<td id='supplier".$row['supplierId']."' class='toNew' ><img class='newItemIcon' supplierId='".$row['supplierId']."' src='".IMG_NEW_ITEM."' width='22px' />
					<td class='toNew' ><img class='newItemProposalIcon' supplierId='".$row['supplierId']."' src='".IMG_NEW_ITEM_PROPOSAL."' width='22px' />
				";
			}
			$tbody.="</tr>";
			/*
